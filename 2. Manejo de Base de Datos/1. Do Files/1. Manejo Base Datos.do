...
* El comando use 
use "$dta/enaho01a-2020-500.dta", clear
...
clear all
unicode analyze "enaho01a-2020-500.dta"
unicode encoding set "latin1"  				// puede ser con ISO-8859-10 también 
unicode translate "enaho01a-2020-500.dta"


*==============================
* IV. Explorando las variables
*==============================
...
* Para continuar la proxima clase!!: Romina Garibay (Delegada)
...
*========================================
* VIII. Borrando y manteniendo variables
*========================================
...
*=========================================
* IX. Ordenando Observaciones y Variables
*=========================================
...
*====================================
* X. Etiquetando Variables y Valores
*====================================
...
*============================
* XI. Guardar y Exportar
*============================

* El comando save
*------------------
save "base_laboral_2020.dta", replace
save "$works/base_laboral_2020.dta", replace


* El comando export excel
*-------------------------
export excel using "$works/base_laboral_2020.xlsx", firstrow(variables) replace
export excel using "$works/base_laboral_2020.xlsx" if dpto==15, firstrow(variables) sheet("lima") 
export excel using "$works/base_laboral_2020.xlsx" in 1/7, firstrow(variables) sheet("selec_in") 


* El comando erase
*------------------
erase "base_laboral_2020.dta"
erase "$works/base_laboral_2020.xlsx"
